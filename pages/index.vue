		...
		<div id="accueil" :style="{'background-color': '#00C692'}">
			...
			<div id="conteneur">
				...
				<div id="credits">
					...
					<p>{{ new Date().getFullYear() }} - <a href="https://ladigitale.dev" target="_blank" rel="noreferrer">La Digitale</a> - <a href="https://gitlab.com/ladigitale/digipad" target="_blank" rel="noreferrer">{{ $t('codeSource') }}</a></p>
				</div>
			</div>
		</div>

<template>
	<div id="app">
		<a id="beekeebox-home" href="http://beekee.box" style="padding-top:6px; display:block;padding:3px 4px;background-color:yellow;border-width: 0 1px 1px 1px;border-style: none;border-color:none; border-radius:0 0 5px 5px;position:fixed;top:0;left:50%;transform: translate(-50%, 0);z-index:5000;box-shadow:0 3px 5px 1px rgba(35, 35, 193, 0.08)">
